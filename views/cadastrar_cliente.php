...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  ...
  <form action="cadastrar_cliente.php" method="post" aria-label="Formulário de Cadastro de Cliente">
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="date" class="form-control" id="data_nascimento" name="data_nascimento" aria-label="Data de Nascimento">
    </div>
